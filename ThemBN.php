...
<body>
    ...
    <?php 
    $ma_the_bhyt = $_REQUEST["ma_the_bhyt"];
?>
    <div class="contaner d-flex justify-content-center align-items-center mt-3">

        <form class="shadow p-4 border rounded" name="form1" method="post" action="XulyThemBN.php"
            onsubmit="return validateForm()">
            <h1 class='text-primary text-center mb-3'><b>THÊM BỆNH NHÂN</b></h1>
            ...
            <div class="input-group mb-3">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" name="tDiachi" id="tDiachi">
            ...
            <div class="input-group mb-3">
                ...
                <div class="form-floating">
                    <input type="number" class="form-control" name="tMathe" id="tMathe" value='<?=$ma_the_bhyt?>'>
            ...
            <div class="input-group mb-3">
                ...
                <div class="form-floating">
                    <input type="text" class="form-control" name="tBenh" id="tBenh">
            ...
            <div class="form-floating mb-3">
                <select class="form-select" name="tTrangThai" id="tTrangThai"
                    aria-label="Floating label select example">
                    <option>Chọn tình trạng khám bệnh</option>
                    <option value='1'>Đang điều trị</option>
                    <option value="0">Đã xuất viện</option>
                </select>
